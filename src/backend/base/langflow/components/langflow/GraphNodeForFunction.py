...
class GraphNodeForFunction(Component):
    ...
    inputs = [
        ...
        HandleInput(
            ...
            "Must have (state, memories: Optional[str] = "", model_schema: Optional[str] = "") as parameters for the async wrapper function. Order matter.\n"  # noqa: E501
            "Example: \n"
            "Input state has 'second' field\n"
            "Output state has 'result' field\n"
            "```code```\n"
            "from typing import Optional\n"
            "async def function_(state, memories: Optional[str] = '', model_schema: Optional[str] = ''):\n"
    ...
    def build_graph(self) -> "GraphNodeForFunction":
        ...
        async def node_function(  # noqa: D417
            ...
            try:
                ...
                result = await self.function_(state, mem_str, verbose_str)
