from crewai import Agent, Crew, Process, Task  # noqa: N999

from langflow.base.agents.crewai.crew import BaseCrewComponent  # type: ignore  # noqa: PGH003
from langflow.io import HandleInput, Output


class SequentialCrewForLangGraphComponent(BaseCrewComponent):
    display_name: str = "Sequential Crew For LangGraph"
    ...
    @property
    def agents(self: "SequentialCrewForLangGraphComponent") -> list[Agent]:
