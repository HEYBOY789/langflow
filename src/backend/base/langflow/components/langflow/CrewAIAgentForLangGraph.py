from crewai import Agent  # noqa: N999

from langflow.base.agents.crewai.crew import convert_llm, convert_tools  # type: ignore  # noqa: PGH003
...
class CrewAIAgentComponent(Component):
    ...
    display_name = "CrewAI Agent For LangGraph"
    description = ("Represents an agent of CrewAI. For the prompt, use {variable} to refer to the state's fields. "
