...
class CreateStateGraphComponent(Component):
    ...
    outputs = [
        Output(display_name="CreateStateGraph", name="output", method="build_output"),
    ]
    ...
    def _create_state_graph(
            ...
            output_model: type[BaseModel]) -> StateGraph:
    ...
    def build_output(self) -> "CreateStateGraphComponent":
        ...
        # Create state graph
        builder = self._create_state_graph(overall_model, input_model, output_model)
